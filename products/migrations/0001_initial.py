    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Description of the kitchen station"
                    ),
                ),
                (
                    "sort_order",
                ...
                (
                    "store",
                    models.ForeignKey(
                        help_text="Kitchen stations are store-specific",
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="kitchen_stations",
                        to="core.store",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.IntegerField(default=1, help_text="Image version for sync"),
                ),
                (
                    "photo",
                    models.ImageField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["company", "is_active"], name="kitchen_sta_company_e3e2d9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="kitchenstation",
            index=models.Index(
                fields=["brand", "is_active"], name="kitchen_sta_brand_i_173560_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="kitchenstation",
            index=models.Index(
                fields=["store", "is_active"], name="kitchen_sta_store_i_4d6c03_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="kitchenstation",
            index=models.Index(
                ...
                name="kitchen_sta_company_358204_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="kitchenstation",
            index=models.Index(fields=["code"], name="kitchen_sta_code_f9f0ae_idx"),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["company", "is_active"], name="table_area_company_547d07_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tablearea",
        ...
        migrations.AddIndex(
            model_name="tables",
            index=models.Index(
                fields=["area", "is_active"], name="tables_area_id_04e60d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tables",
            index=models.Index(fields=["number"], name="tables_number_00dfc3_idx"),
        ),
        migrations.AddIndex(
